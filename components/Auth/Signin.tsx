          ...
          >
            ...
            <div className="flex items-center gap-8">
              <button
                ...
                className="text-body-color mb-6 flex w-full items-center justify-center rounded-sm border border-primary border-stroke bg-[#f8f8f8] bg-primary/5 px-6 py-3 text-base text-primary outline-none transition-all duration-300"
              >
                <span className="mr-3">
                  <svg
                    width="20"
